defmodule FlashProfile.Atoms.CharClass do
  ...
  Provides predefined character class atoms with associated **static costs** that
  influence pattern selection.

  > **Note:** These atoms are based on the FlashProfile research paper.
